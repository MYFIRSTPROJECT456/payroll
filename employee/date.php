...
$result = mysqli_query($link,"SELECT * FROM employee WHERE DAYOFYEAR(time) = DAYOFYEAR('$time')  AND YEAR(time) = YEAR('$time') AND empno = $empno");
...
<hr width="800"/>
<div class="copy">
Copyright &nbsp; &copy;  2016&nbsp;&nbsp; ABC&nbsp;&nbsp; COMPANY</div>
</div>
